...
| :--- | :--- | :---: |
| 1. **Requisitos del Sistema** | Requisitos de software, permisos y SQL Server. | [Ir a Sección ⚙️](#requisitos) |
| 2. **Credenciales de Windows** | **Requisito Obligatorio**: Configurar contraseña real (no PIN/Hello). | [Ir a Sección 🔑](#credenciales-windows) |
| 3. **Configuración de Dropbox** | Guía de creación de App, permisos y Tokens en Dropbox. | [Ir a Sección ☁️](#configuracion-dropbox) |
| 4. **Guía de Uso Rápido** | Pasos sencillos para crear y programar tu primera tarea. | [Ir a Sección 📖](#guia-de-uso) |
| 5. **Características Principales** | Políticas de retención, cifrado DPAPI, explorador de respaldos y logs. | [Ir a Sección ✨](#caracteristicas) |
| 6. **Arquitectura del Sistema** | Explicación del diseño desacoplado (WinForms GUI + Consola Worker). | [Ir a Sección 🛠️](#arquitectura) |
| 7. **Estructura del Proyecto** | Organización de archivos y proyectos en la solución. | [Ir a Sección 📁](#estructura-proyecto) |
...
1. Abre **CMD** o **PowerShell** ejecutándolo como Administrador.
